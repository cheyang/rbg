...
> **Note**: The `InPlaceOnly` strategy is not recommended. When changes exceed image scope, this strategy does not fall back to Pod recreation and the update gets stuck. Use `InPlaceIfPossible` instead.
