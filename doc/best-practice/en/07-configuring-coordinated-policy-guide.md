...
- `prefill` and `decode` create Pods at similar progress rates
...
- `rollingUpdate.maxSkew: 1`: The update progress difference between the two roles is at most 1 instance
...
- During the update, the difference in updated instance count between the two roles does not exceed 1
